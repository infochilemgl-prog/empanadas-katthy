    ...
    <header className="sticky top-0 z-50 bg-cream/95 backdrop-blur border-b border-charcoal/10">
      <div className="max-w-6xl mx-auto px-5 py-3 flex items-center justify-between">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-leaf text-charcoal px-4 py-2 text-sm font-bold hover:bg-charcoal hover:text-cream transition-colors"
        >
          WhatsApp
        </a>
      </div>
